    ...
    <div style="text-align: center; padding: 1.2rem;">
        ...
        <div style="display: flex; justify-content: center; gap: 2rem; margin-top: 1.5rem; flex-wrap: wrap;">
            <div style="text-align: center; transition: all 0.3s ease;" class="tech-decoration" onmouseover="this.style.transform='translateY(-5px)'" onmouseout="this.style.transform='translateY(0)'">
                <div style="font-size: 2.5rem; color: var(--accent-color); margin-bottom: 0.8rem;">📊</div>
                <div style="color: var(--text-secondary); font-size: 1.4rem; font-weight: 500;">多格式支持</div>
            </div>
            <div style="text-align: center; transition: all 0.3s ease;" class="tech-decoration" onmouseover="this.style.transform='translateY(-5px)'" onmouseout="this.style.transform='translateY(0)'">
                <div style="font-size: 2.5rem; color: var(--accent-color); margin-bottom: 0.8rem;">🤖</div>
                <div style="color: var(--text-secondary); font-size: 1.4rem; font-weight: 500;">AI智能分析</div>
            </div>
            <div style="text-align: center; transition: all 0.3s ease;" class="tech-decoration" onmouseover="this.style.transform='translateY(-5px)'" onmouseout="this.style.transform='translateY(0)'">
                <div style="font-size: 2.5rem; color: var(--accent-color); margin-bottom: 0.8rem;">📈</div>
                <div style="color: var(--text-secondary); font-size: 1.4rem; font-weight: 500;">可视化图表</div>
            </div>
            <div style="text-align: center; transition: all 0.3s ease;" class="tech-decoration" onmouseover="this.style.transform='translateY(-5px)'" onmouseout="this.style.transform='translateY(0)'">
                <div style="font-size: 2.5rem; color: var(--accent-color); margin-bottom: 0.8rem;">⚡</div>
                <div style="color: var(--text-secondary); font-size: 1.4rem; font-weight: 500;">实时处理</div>
            </div>
        </div>
    </div>
</div>
...
if data:
    try:
        ...
        if isinstance(df_result, dict) and "sheets" in df_result:
            ...
            st.markdown("""
            <div class="tech-card">
                <h3 style="color: var(--accent-color); margin-bottom: 1.5rem; text-align: center; font-size: 1.6rem; font-weight: 500;">📊 数据统计概览</h3>
            </div>
            """, unsafe_allow_html=True)
            ...
            with col1:
                ...
                <div class="metric-card">
                    <div style="font-size: 1.8rem; color: var(--accent-color); text-align: center;">📏</div>
                    <div style="font-size: 1.6rem; font-weight: 600; color: var(--text-dark); text-align: center; margin: 0.5rem 0;">{}</div>
                    <div style="color: var(--text-secondary); text-align: center; font-size: 1rem;">总行数</div>
                </div>
            ...
            with col2:
                ...
                <div class="metric-card">
                    <div style="font-size: 1.8rem; color: var(--accent-color); text-align: center;">📋</div>
                    <div style="font-size: 1.6rem; font-weight: 600; color: var(--text-dark); text-align: center; margin: 0.5rem 0;">{}</div>
                    <div style="color: var(--text-secondary); text-align: center; font-size: 1rem;">总列数</div>
                </div>
            ...
            with col3:
                ...
                <div class="metric-card">
                    ...
                    <div style="font-size: 1.6rem; font-weight: 600; color: var(--text-dark); text-align: center; margin: 0.5rem 0;">{}</div>
                    <div style="color: var(--text-secondary); text-align: center; font-size: 1rem;">缺失值</div>
                </div>
...
if "df" in st.session_state:
    st.markdown("""
    <div class="tech-card tech-border">
        <h2 style="color: var(--accent-color); margin-bottom: 1.5rem; text-align: center; font-size: 1.8rem; font-weight: 500;">🤖 AI智能分析</h2>
    ...
    <div class="tech-card tech-border" style="text-align: center; padding: 3rem 2rem;">
        ...
        <p style="color: var(--text-secondary); font-size: 1.2rem;">上传数据后即可开始AI智能分析</p>
    ...
    if st.button("🤖 开始AI智能分析", type="primary", use_container_width=True):
        ...
        if result:
            ...
            if "bar" in result:
                st.markdown("""
                <div class="tech-card">
                    <h3 style="color: var(--accent-color); margin-bottom: 1rem; font-size: 1.6rem; font-weight: 500;">📈 可视化图表</h3>
